...
import '../../presentation/pages/app_settings_screen.dart';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.notesList:
        return MaterialPageRoute(builder: (_) => const EnhancedNotesListScreen());

      case AppRoutes.noteEditor:
        // Note: Enhanced editor with all features
        final args = settings.arguments;
        return MaterialPageRoute(
          builder: (_) => EnhancedNoteEditorScreen(note: args is Note ? args : null),
        );
      ...
      case AppRoutes.remindersList:
        return MaterialPageRoute(builder: (_) => const EnhancedRemindersListScreen());
      ...
      case AppRoutes.globalSearch:
        return MaterialPageRoute(builder: (_) => const EnhancedGlobalSearchScreen());
