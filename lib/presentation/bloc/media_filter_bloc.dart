...
import 'params/media_filter_params.dart';
...
class MediaFilterInitial extends MediaFilterState {
  const MediaFilterInitial(MediaFilterParams params) : super(params);
}

class MediaFilterUpdated extends MediaFilterState {
  const MediaFilterUpdated(MediaFilterParams params) : super(params);
}
