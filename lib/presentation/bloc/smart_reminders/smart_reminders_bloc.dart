...
class SmartRemindersLoaded extends SmartRemindersState {
  ...
  List<Map<String, dynamic>> get suggestions => params.suggestions;
  List<Map<String, dynamic>> get patterns => params.patterns;
  List<Map<String, dynamic>> get reminders => params.reminders;
}
