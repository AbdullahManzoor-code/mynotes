...
class _TagManagementScreenState extends State<TagManagementScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          _buildAllTagsTab(context),
          _buildOrganizeTab(context),
  ...
  Widget _buildAllTagsTab(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _buildTagCard(tags[index], context, index);
                  },
                ),
              ],
            ),
      ...
      onLongPress: () {
        setState(() {
          if (isSelected) {
            ...
            selectedTags.add(tag['name'] as String);
          }
        });
      },
      onTap: () {
